...
function credits:init(...)
	...
	gfx.sprite.setBackgroundDrawingCallback(function(width, height, x, y)
		...
		assets.newsleak:drawText(text("creditscheevos"), 10, 110)
		assets.newsleak:drawText(text("creditsthanks"), 10, 130)
		assets.newsleak:drawText(text("creditswandering"), 10, 160)
